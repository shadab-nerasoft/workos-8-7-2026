...
import type { Project, TaskStatus, Priority, User as UserType } from "@/src/types";
...
interface CalendarFiltersProps {
  ...
  /** Projects pre-scoped to what the current user may see, provided by the page. */
  accessibleProjects: Project[];
  /** Users available for the assignee filter, provided by the page. */
  users: UserType[];
  /** Whether the assignee filter is shown (computed by the page via permissions). */
